...
<div class="d-flex">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('update.jadwal') }}" method="POST">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="namaMatakuliah" value="{{ $item->nama_matkul }}" disabled>
                                                    </div>
    ...
    <div class="mb-3">
        ...
        <select name="nama_ruang" id="namaRuang" class="form-select" required>
...
<div class="mb-3">
    ...
    <input type="time" class="form-control" id="jam_mulai_{{ $item->id_jadwal }}" name="jam_mulai" value="{{ \Carbon\Carbon::parse($item->jam_mulai)->format('H:i') }}" required>
</div>

<!-- Jam Selesai -->
<div class="mb-3">
    <label for="jam_selesai_{{ $item->id_jadwal }}" class="form-label">Jam Selesai</label>
    <input type="time" class="form-control" id="jam_selesai_{{ $item->id_jadwal }}" name="jam_selesai" value="{{ \Carbon\Carbon::parse($item->jam_selesai)->format('H:i') }}" required>
</div>
