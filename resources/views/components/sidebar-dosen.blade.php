...
@endphp
    ...
    @if ($userRole == 'dosen' || ($userRole == 'dosen' &&  $roleSelected == 'dosen'))
        <!-- SIDEBAR DOSEN -->
        <a href="{{ route('sidebar.dosen') }}" class="nav-link">Dosen</a>
        <div class="text-center mb-4">
            ...
            <p class="small opacity-75">NIP. {{ $dosen_side->nip }}</p>
            <p class="small opacity-75">Dosen<br>Program Studi S1 {{ $dosen_side->prodi_nama }}<br> Fakultas Sains dan Matematika</p>
        </div>
