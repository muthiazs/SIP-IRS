    ...
    public function run(): void
    {
        ...
        DB::table('kalender_akademik')->insert([
            ...
            [
                ...
                'tanggal_mulai' => $threeWeeksLater->toDateTimeString(), // Mulai 3 minggu dari sekarang (same as gantiIRS/batalIRS)
            ...
            [
                ...
                'tanggal_mulai' => $threeWeeksLater->toDateTimeString(), // Mulai 3 minggu dari sekarang
